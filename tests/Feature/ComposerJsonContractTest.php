...
class ComposerJsonContractTest extends TestCase
{
    ...
    public function test_phpunit_pinned_to_modern_majors(): void
    {
        ...
        $this->assertStringNotContainsString('~9', $constraint, 'Drop legacy PHPUnit 9 union.');
    }
    ...
    public function test_testbench_supports_l11_l12_l13(): void
    {
        ...
        foreach (['^9.0', '^10.0', '^11.0'] as $required) {
            $this->assertStringContainsString($required, $constraint);
        }
        $this->assertStringNotContainsString('~8', $constraint, 'Drop testbench 8 — its baseline is L10.');
    }
    ...
    public function test_composer_validate_succeeds(): void
    {
        ...
        $this->assertSame(0, $exit, "composer validate --strict failed:\n".implode("\n", $output));
    }
}
